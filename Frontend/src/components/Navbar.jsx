      ...
      <div className="navbar-end hidden md:flex">
        {authUser ? (
          <div className="dropdown dropdown-end">
            ...
            >
              <div className="w-10 rounded-full bg-lime-600 text-secondary-content">
                <span className="text-white text-xl ">{authUser.name?.charAt(0) || "A"}</span>
              </div>
            </label>
            <ul
              tabIndex={0}
          ...
          <div className="flex items-center gap-2">
            <Link
              to="/login"
              className="btn btn-ghost btn-sm normal-case flex items-center"
            >
              <User className="w-4 h-4 mr-2" /> Login
            </Link>
